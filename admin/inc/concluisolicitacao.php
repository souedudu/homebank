...
<table width="750" border="0" cellspacing="0" class=form>
  <tr>
      ...
      <td align="center" class="td2">
          <b>Consulta de Solicitação para Conclusão de Atendimento - New</b>
      </td>
  </tr>
</table>
 <BR>
...
<?  
  ...
  { 
	  ...
	  { 
		 ...
		 $onclickcodsolicitacao = "window.open('conclusaosolicitacao.php?codsolicitacao=".$codsolicitacao1[$prox]."','','width=600,height=450,scrollbars=NO, left=200, top=150')";
		 
		 $opcaosol1 = "<a href='javascript://;' onclick=".chr(34).$onclickcodsolicitacao.chr(34)."><img src='img/conclusao_solicitacao.gif' width=15 height=15 border='0' alt='Conclusão da solicitação.'></a>";
	...
	$objpaginacao->link="concluisolicitacao.php";
