...
/
<input name="ano_fim" value="<?php echo $ano_fim;?>" type="text" id="ano_fim" size="5" maxlength="4" /></td>
    </tr>
    <tr>
      <td colspan="2">CÓD SOL.:
      ...
      <input name="codtecnicoresp" value="<?php echo $codtecnicoresp;?>" type="text"  id="codtecnicoresp" size="6" /></td>
    </tr>
...
?>
  ...
  <?php } elseif ($tp_relatorio ==2){ ?>
    <tr class="td4">
      ...
      <td><div align="left">Difereça</div></td>
      </tr>
    <?php do { 
      if($cont%2==0)
        $cor="#F5F5F5";
...
?>
  ...
  <?php } elseif ($tp_relatorio ==3){ ?>
    <tr class="td4">
      <td><div align="left">CÓD. OS</div></td>
      <td><div align="left">Técnico Abertura</div></td>
