...
?>
  ...
  <tr><!-- row 5 -->
   <td colspan="18" background="img2/fakemenu.gif"><img src="img/menubar.jpg" name="image1" border="0" usemap="#Map" id="image1"><map name="Map">
  ...
  <tr><!-- row 6 -->
   <td colspan="18"><img name="index_15" src="img2/index_15.gif" width="771" height="25" border="0" alt=""></td>
   <td><img src="img2/spacer.gif" width="1" height="25" border="0" alt=""></td>
  </tr>
  <tr><!-- row 7 -->
    <td colspan="18" rowspan="5" bgcolor="#FFFFFF"><?
	switch($nomePAG)
	{
...
?>		</td>
  ...
  <tr><!-- row 12 -->
   ...
   <td colspan="2" bgcolor="#FFFFFF"><img src="img2/spacer.gif" width="1" height="1" border="0" alt=""></td>
   <td rowspan="2" bgcolor="#FFFFFF"><img src="img2/spacer.gif" width="1" height="1" border="0" alt=""></td>
   <td colspan="2" bgcolor="#FFFFFF"><img src="img2/spacer.gif" width="1" height="1" border="0" alt=""></td>
