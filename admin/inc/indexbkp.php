<?php include "inc/tecnicos_solicitacoes.php";?>
...
function mostrasolicitacoes($tecnico){
  ...
  <tr>
    <td><strong>N° da solicitação&nbsp;&nbsp;&nbsp;</strong></td>
...
<?php $i=0;?>
  <?php do { ?>
    ...
    <tr>
      <td></td>
      <td colspan="2"><div id="tabeladetalhes[<?php echo $i;?>]" style="height:0px; visibility:hidden;">Qtd Total: <?php echo @mostrasolicitacoes($row_solicitacoes['codtecnicoresp']); ?></div>
    </td>
    </tr>
<?php $i=$i+1; ?>
