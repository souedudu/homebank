...
<table width="90%">
  ...
  <table border="0" cellpadding="0" cellspacing="0">
    <tbody>
      <tr valign="top" class="td4">
        <td width="226"><strong>Data de abertura:</strong></td>
        <td width="252"><strong>N&uacute;mero Solicita&ccedil;&atilde;o:</strong></td>
      </tr>
      <tr valign="top">
  ...
  <table border="1" cellpadding="0" cellspacing="0">
    <tbody>
      <tr valign="top">
        <td class="td4"><strong>Conta Corrente / Nome</strong>:</td>
        <td><?php echo $row_solicitacao['numcontacorrente']; ?> - <?php echo $row_solicitacao['nomcliente']; ?></td>
      </tr>
      <tr valign="top">
        <td class="td4"><strong>CPF / CNPJ:</strong></td>
        <td><?php

	$numcpfcnpj = 1*$row_solicitacao['numcpfcnpj'];
  if ($numcpfcnpj > 99999999999)
    echo formataCampo("CNPJ", $row_solicitacao['numcpfcnpj']);
	else 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <br>
          ...
          <?php echo $row_solicitacao['desproduto']; ?><br />
          <br />
          <strong>Detalhes desta solicita&ccedil;&atilde;o:</strong><br />
          <?php echo $row_solicitacao['dessolicitacao']; ?><br />
          <br />
          <strong>Procedimento/Fase</strong><br />
          <strong> </strong>
          <?php if($row_solicitacao['concluida']=='N'){ ?>
          <select size="30" name="tec_responsavel" id="tec_responsavel" onchange="if(this.value!='0'){ location.href='inc/alteratecnicoresp.php?tecnico='+this.value+'&solicitacao=<?php echo $_GET['cod'];?>'; }">
