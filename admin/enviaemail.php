...
class EnviaEmail 
{
  ...
  function emailAcompanhamento($email){
    ...
    $email['conteudo'] .= '<img src="http://www.sicoobcrediembrapa.com.br/images/imgs/cabecalho.jpg"><br><table width="600" border="0"><tbody><tr>';
    $email['conteudo'] .= "<td>Prezado(a) Associado(a), <br><br>";
    $email['conteudo'] .= "Sua solicitação nº: <b>".$email['os']."</b> está em andamento. Seguem informações para conhecimento:<br><br><b><i>\"".$email['descompmensagem']."\"</b></i></td></tr></tbody></table>";
  ...
  function emailAbertura($email){
    $email['conteudo'] = "<html><head></head><body>";
    $email['conteudo'] .= '<img src="http://www.sicoobcrediembrapa.com.br/images/imgs/cabecalho.jpg"><br><table width="600" border="0"><tbody><tr>';
    $email['conteudo'] .= "<td><br><br>Prezado(a) Associado(a), <br>
Sua solicitação foi registrada através da OS: <b>".$email['os']."</b><br><br>";
    ...
    $email['conteudo'] .= "Sicoob </td></tr></tbody></table>";
  ...
  function emailAvaliacao($email){
    $email['conteudo'] = "<html><head></head><body>";
    $email['conteudo'] .= '<img src="http://www.sicoobcrediembrapa.com.br/images/imgs/cabecalho.jpg"><br><table width="600" border="0"><tbody><tr>';
    $email['conteudo'] .= "<td><br><br>Prezado(a) associado(a), <br><br>
Sua solicitação da <b>OS ".$email['os']."</b> foi encerrada com sucesso.<br><br>";
    $email['conteudo'] .= 'Gostaríamos de saber sua opini&atilde;o sobre o nosso atendimento<br><br> Segue o link para avaliação do atendimento: <a href="'.$email['link'].'">Clique aqui para acessar.</a></td></tr></tbody></table>';
    $email['conteudo'] .= '<br><img src="http://www.sicoobcrediembrapa.com.br/images/imgs/rodape.jpg"><br>';
    $email['conteudo'] .= "</body></html>";
