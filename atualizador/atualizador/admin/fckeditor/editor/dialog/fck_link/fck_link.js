...
function OnUploadCompleted( errorNumber, fileUrl, fileName, customMsg )
{
	...
	{
		case 0 :	// No errors
			alert( 'Seu arquivo foi carregado com sucesso' ) ;
			break ;
		case 1 :	// Custom error
			alert( customMsg ) ;
			return ;
		case 101 :	// Custom warning
			...
			break ;
		case 201 :
			alert( 'Um arquivo com o mesmo nome ja existe. O arquivo enviado foi renomeado para  "' + fileName + '"' ) ;
			break ;
		case 202 :
			alert( 'Tipo de arquivo invalido' ) ;
			return ;
		case 203 :
			alert( "Erro de segurança. Voce provavelmente nao tem permissao para enviar o arquivo. Por favor verifique em seu servidor." ) ;
			return ;
		default :
			alert( 'Erro ao enviar arquivo. Erro numero: ' + errorNumber ) ;
			return ;
	}
