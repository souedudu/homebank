...
Data Atualização:
Sistema: Home Bank
Descrição: Consulta Solicitação para Avaliação de Atendimento
************************************************************************************/
...
<table width="568" border="0" cellspacing="0" class=form>
  <tr>
      ...
      <td align="center" class="td2">
          <b>Consulta Solicitação para Avaliação de Atendimento</b>
      </td>
  </tr>
</table>
 <BR>
...
<table border="1" width="568" cellspacing="0" cellpading="0" class="table">
  <tr>
      ...
      <td align="right" class="td4" width="150"><b>Nº da Solicitação:</b></td>
...
<table border="1" width="568" cellspacing="0" class="table">
  <tr>
      <td width="5"align="center">&nbsp;</td>
      <td align="right" class="td4" width="150"><b>Tipo Serviço:</b></td>
...
<table border="1" width="568" cellspacing="0" class="table">
  <tr>
      <td width="5"align="center">&nbsp;</td>
      <td align="right" class="td4" width="150"><b>Técnico responsável:</b></td>
...
<table border="1" width="568" cellspacing="0" class="table">
  <tr>
      <td width="5"align="center">&nbsp;</td>
      <td align="right" class="td4" width="150"><b>Detalhes da Solicitação:</b></td>
...
?>
   <table width="568" cellspacing="0" border="1">
     <tr>
         ...
         <td align="left" width="150"><a href="javascript://;" onclick="window.open('../admin/inc/avaliaratendimento.php?codsolicitacao=<?=$codsolicitacao;?>','Triagem','width=610,height=520,scrollbars=NO, left=200, top=120')"><img src="img/Editar.gif" width="15" height="15" border="0" alt="Concluir Solicitação."></a>&nbsp;<b>Avaliar Atendimento</b></td>
