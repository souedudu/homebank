...
<?
  ...
  $query = "Select s.*, t.destiposervsol
  ...
  {  
     $sqltecresp = "Select * From tecnicoresp
                    where codtecnicoresp = ".$dados['codtecnicoresp'];
    $qrytecresp = mysql_query($sqltecresp); 
	$rstec = mysql_fetch_array($qrytecresp);     
  }

?>
<table width="368" border="1" cellspacing="0">
  <tr>
    <td colspan="2" valign="top" align="center"  class="td2">Cadastra andamento da solicitação</td>  
   </tr>	
</table>   
...
<table width="368" border="1" cellspacing="0">
  ...
  <tr>
   ...
   <tr>
	  ...
	  <td class="td3">&nbsp;<? echo $rstec['nomtecnicoresp'];?></td>
  </tr>
...
<?
   ...
   $sqlstring4 = "select a.* from andamensolicitacao a
   ...
   if (!($rsresult3 == 0))
   {
      echo "<table width='368' border='1' cellspacing='0' class=form>";
      echo "<tr>";
      echo "<td width='5'>&nbsp;";
      echo "</td>";
...
?>
        <table width='368' border='1' cellspacing='0' class=form>
           <tr>
             <td width='5'>&nbsp;</td>
