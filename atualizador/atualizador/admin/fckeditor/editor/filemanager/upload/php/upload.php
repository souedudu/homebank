...
$ConfigDirectories = $Config['ConfigDirectories'][$sType].'/' ; //Variavel inserida por Carlos Eduardo <carloseduardo.webdeveloper@gmail.com>
...
while ( true )
{
	...
	$sFilePath = $sServerDir . $ConfigDirectories . $sFileName ; //Alteração da linha original <$sFilePath = $sServerDir . $sFileName ;>
	...
	else
	{
		...
		$sFileUrl = $Config["UserFilesPath"] . $Config['ConfigDirectories'][$sType].'/' . $sFileName ; //Alteração da linha original <$sFileUrl = $Config["UserFilesPath"] . $sFileName ;>
