...
if ($bttipoacao != "")
{
  ...
  if ($bttipoacao == "Incluir")
  {
	...
	{
       $sql = "insert into solicitacaoserv (codcliente, codtiposervsol, numcontacorrente, dessolicitacao, desemailcont, numtelefonecont, dtsolicitacao) values (".$_SESSION['codcliente'].",".$codtiposervsol.",'".$numcontacorrentesol."','".$dessolicitacao."','".$desemailcont."','".$numtelefonecont."','".$dtsolicitacao."')";
	}
	
	// Se for o usuário que estive logado então sql do usuario  
	if ($_SESSION['codtecnicorespadm'] != "")
	{
       $sql = "insert into solicitacaoserv (codtecnicosol, codtiposervsol, numcontacorrente, dessolicitacao, desemailcont, numtelefonecont, dtsolicitacao) values (".$_SESSION['codtecnicorespadm'].",".$codtiposervsol.",'".$numcontacorrentesol."','".$dessolicitacao."','".$desemailcont."','".$numtelefonecont."','".$dtsolicitacao."')";
	}	
...
<br>
<br>
 <table width="580" border="1" cellspacing="0" cellpadding="0" class="table">
  <tr>
    <td width="5">&nbsp;</td>
...
?>
  <tr><td width="3">&nbsp;</td>
	...
	<td class="td3"><? if ($coddelegado != "") echo "<br>";?>&nbsp;<input name="numcontacorrentesol" value="<?=$rsresult['numcontacorrente'];?>" type="text" id="numcontacorrentesol" size="10" maxlength="15" <? if ($tipoacao=="Editar") echo "readonly style='border:none;'"?> >&nbsp;&nbsp;Exemplo: 9822 (Não digite "-" ou ".") 
	<? if ($coddelegado != "")
	   {
...
<?
  ...
  <tr><td width="5">&nbsp;</td>
    ...
    <td class="td3">&nbsp;<?=$dtsolicitacao;?><br></td>
  </tr>
...
-->
  ...
  <tr><td width="5">&nbsp;</td>
    <td class="td4" align="right"><b>Técnico responsável</td>
	 ...
	 <td class="td3">
<? 
if ($rsresult['codtecnicoresp'] != "" || $acaotriagem != "")
{
?>	 
...
?>
   ...
   <tr><td width="5">&nbsp;</td>
    <td class="td4" align="right"><b>E-Mail de contato</td>
	   <td class="td3">&nbsp;<input name="desemailcont" value="<?=$rsresult['desemailcont'];?>" type="text" id="desemailcont" size="50" maxlength="60" <? if ($tipoacao=="Editar") echo "readonly style='border:none;'";?>>
	   </td>
  </tr>

   <tr><td width="5">&nbsp;</td>
    <td class="td4" align="right"><b>Telefone de contato</td>
	   <td class="td3">&nbsp;<input name="numtelefonecont" value="<?=$rsresult['numtelefonecont'];?>" type="text" id="numtelefonecont" size="15" maxlength="15" <? if ($tipoacao=="Editar") echo "readonly style='border:none;'"?>>
	   </td>
  </tr>
