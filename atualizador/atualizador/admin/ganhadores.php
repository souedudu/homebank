...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "ganhadores.php?save=ok";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_crediembrapa, $crediembrapa);
$query_Recordset1 = "SELECT paginas.html FROM paginas WHERE paginas.id = 2";
...
<!-- fwtable fwsrc="CrediEmbrapa.png" fwbase="crediembrapa.png" fwstyle="Dreamweaver" fwdocid = "2122681717" fwnested="0" -->
  ...
  <tr>
   ...
   <td><img src="../images/spacer.gif" width="1" height="5" border="0" alt="" /></td>
    ...
    <tr>
      <td valign="top"><p class="style2">[ <a href="index.php">Home</a> | <a href="ganhadores.php">Editar Ganhadores</a> | <a href="premios.php" class="style2">Editar Pr&ecirc;mios</a> ]</p>
