...
{
    // Grava questionario
	$sql = "insert into avaliacaosol (codsolicitacao, flaformarelac, flaqualatendimento, flatempoatendimento, flaavalatendimento, desavaliacao) values (".$codsolicitacao.",'".$flaformarelac."','".$flaqualatendimento."','".$flatempatendimento."','".$flaavalatendimento."','".$desavaliacao."'".")";
